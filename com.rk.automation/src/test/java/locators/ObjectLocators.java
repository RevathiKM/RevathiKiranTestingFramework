...
public interface ObjectLocators {
	...
	final String objAddNew="//div[@class=\"title ellipsis\"]";
	final String objNewCustomer="//div[@class=\"item createNewCustomer ellipsis\"]";
	final String objCustomerName="//input[@id=\"customerLightBox_nameField\"]";
	final String objCreateUser="//div[@class=\"greyButton withIcon commitBtn\"]";
	final String objTextContain="//a[@class=\"allCustomers\"]";
